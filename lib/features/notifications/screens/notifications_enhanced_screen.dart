...
class NotificationsEnhancedScreen extends StatefulWidget {
  const NotificationsEnhancedScreen({super.key});

  @override
  State<NotificationsEnhancedScreen> createState() =>
      _NotificationsEnhancedScreenState();
}

class _NotificationsEnhancedScreenState
    extends State<NotificationsEnhancedScreen> {
