...
class FundiCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final portfolioItems = fundi['portfolio_items'] as List<dynamic>? ?? [];
    final averageRating = fundi['average_rating']?.toDouble() ?? 0.0;
              ...
              if (portfolioItems.isNotEmpty) ...[
                ...
                SizedBox(
                  ...
                  child: ListView.builder(
                    ...
                    itemCount: portfolioItems.length > 3 ? 3 : portfolioItems.length,
                    itemBuilder: (context, index) {
                      ...
                      return Container(
                        ...
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(8),
                          child: item['media'] != null && (item['media'] as List).isNotEmpty
                              ? Image.network(
                                  item['media'][0]['url'],
                                  fit: BoxFit.cover,
